...
<section class="p-6 space-y-6 pt-23">
  <a class="btn-ghost" href="<?= routeUrl('/products') ?>" aria-label="Back to products">
  ...
  <div class="overflow-x-auto">
    <table class="table">
      ...
      <tbody id="dispatches-container" data-dispatches-url="<?= htmlspecialchars(routeUrl('/api/dispatches/today'), ENT_QUOTES, 'UTF-8') ?>" data-items-url="<?= htmlspecialchars(routeUrl('/api/dispatches/items'), ENT_QUOTES, 'UTF-8') ?>">
        <tr>
...
<script type="module" src="<?= htmlspecialchars(routeUrl('/public/dist/dispatch-history/index.js'), ENT_QUOTES, 'UTF-8') ?>"></script>