<section class="flex h-screen p-4">
  ...
  <div class="grid w-full md:max-w-2/4 place-items-center">
    ...
    <form class="mx-auto space-y-6 w-96" action="<?= escape_for_html(routeUrl('/sign-in')) ?>" method="post" autocomplete="off">
      <div class="space-y-2">
      ...
      <?php if (!empty($signInError ?? '')): ?>
        <div class="hidden rounded-(--radius) px-4 py-3 text-sm text-destructive-foreground border border-red-500 bg-destructive">
